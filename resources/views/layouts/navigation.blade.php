<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 sticky top-0 z-50 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-2xl font-black text-blue-600 dark:text-blue-400 tracking-tighter">
                        ELMS
                    </a>
                </div>
    ...
    <div x-show="open" 
         ...
         class="sm:hidden absolute w-full left-0 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-xl z-50">
