    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-6">
            ...
            <div>
                ...
                <input id="profile_picture" name="profile_picture" type="file" class="mt-1 block w-full text-sm text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-slate-700 rounded-lg cursor-pointer bg-gray-50 dark:bg-slate-900 focus:outline-none" accept="image/*" />
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Allowed formats: jpeg, png, jpg, gif (Max 2MB)</p>
