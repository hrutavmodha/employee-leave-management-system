<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-3xl font-black text-center text-gray-900 mb-6">Create Department</h1>
                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('departments.store') }}" class="space-y-6 max-w-xl">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="4" placeholder="Brief overview of the department's responsibilities...">{{ old('description') }}</textarea>
