<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <p class="text-center text-gray-600 dark:text-gray-400 mb-6 max-w-3xl mx-auto text-sm leading-relaxed">Update the leave policy parameters. Modifications will update the rules for <strong>allowable days and carry-forward limits</strong> across the organization.</p>
                    ...
                    <form method="POST" action="{{ route('leave-types.update', $leaveType) }}" class="space-y-6 max-w-xl">
                        ...
                        <div class="block">
                            <label for="carry_forward" class="inline-flex items-center">
                                <input id="carry_forward" type="checkbox" class="rounded border-gray-300 dark:border-slate-700 dark:bg-slate-900 text-indigo-600 shadow-sm focus:ring-indigo-500 focus:ring-offset-white dark:focus:ring-offset-slate-800" name="carry_forward" value="1" {{ old('carry_forward', $leaveType->carry_forward) ? 'checked' : '' }}>
